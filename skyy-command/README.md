...
6. **Configure deploy key** - Generates SSH deploy key for skyy-command repository access
   ...
   - **Important**: leave the key **read-only** (the GitHub default) — the bootstrap only clones, and read-only is the least privilege that works ([GitHub Automation Standard §1](https://github.com/helloskyy-io/mdc-master-planning/blob/main/standards/github-automation/github_standard.md))
